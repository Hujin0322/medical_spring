...
public class FController {
	...
	public String oauth(String code) {
		...
		String client_id = "18cc75577bb86bfbed317e39ad358651";
...
//      conn.setRequestProperty("Content-type", "application/json");
		...
		//header 오브젝트, MultiValueMap을 1개 오브젝트로 묶음
		HttpEntity<MultiValueMap<String, String>> kakaoTokenRequest = 
				new HttpEntity<>(params, headers);
		
		//Http 요청
		//RestTemplate 형태로 데이터를 담아 oauthUrl로 post방식으로 kakaoTokenRequest(데이터 = String으로) 보냄
		...
		//ObjectMapper의 데이터를 oAuthTOkenDto에 넣기
		try {
...
//		try {
//			kakaoDto =  objectMapper2.readValue(response.getBody(),KakaoDto.class);
//		} catch (Exception e) {e.printStackTrace();}
