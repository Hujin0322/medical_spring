...
public class EmailServiceImpl implements EmailService {
	...
	public void email_send(String name, String email) {
		...
		message.setTo(email);
		message.setFrom("letty0322@gmail.com");
		message.setSubject(name+"님의 비밀번호 초기화 되었습니다.\n" );
	...
	public void email_send2(String name, String email) {
		...
		try {
			message.setSubject("[ 안내 ]"+name+"님의 비밀번호가 초기화되었습니다.","utf-8");
			String htmlData = "<tr>\r\n"
					...
					+ "<p style='width:620px;margin:30px 0 0 0;padding:0;text-align:center;'><img src='localhost8181/images/join/img_txt_password02.jpg' alt='JARDIN에서 비밀번호 찾기를 요청하셨습니다.' /></p>\r\n"
			...
			//보내는 이메일 주소
			message.setFrom(new InternetAddress("letty0322@gmail.com"));
			//받는 이메일 주소
