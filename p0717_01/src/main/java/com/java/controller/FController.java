...
public class FController {
	...
	public String public_data(@RequestParam(defaultValue = "1") String page) throws Exception {
		...
		//API 호출
		String service_key = "A9h90cBuJ1fJdIeHuTDoiFIPt%2FTBHQJ8BYIzGp6RMJqA3VIOXymS8Bhz62YHJNUVH8O%2FEo2sN960gOXZfUCmLg%3D%3D";
	...
	@PostMapping("/public_data_keyword") //공공데이터 가져오기
	@ResponseBody
	public String public_data_keyword(String keyword) throws Exception {
